...
var j = (e, n, r) => (Vr(e, typeof n != "symbol" ? n + "" : n, r), r), Ke = (e, n, r) => {
  if (!n.has(e))
    throw TypeError("Cannot " + r);
};
var p = (e, n, r) => (Ke(e, n, "read from private field"), r ? r.call(e) : n.get(e)), v = (e, n, r) => {
  if (n.has(e))
    throw TypeError("Cannot add the same private member more than once");
  n instanceof WeakSet ? n.add(e) : n.set(e, r);
}, D = (e, n, r, i) => (Ke(e, n, "write to private field"), i ? i.call(e, r) : n.set(e, r), r);
var E = (e, n, r) => (Ke(e, n, "access private method"), r);
function T(e, n) {
  e.classList.add(n);
}
function fn(e, n) {
...
function zr(e, n) {
  ...
  function r(o, u) {
    ...
    T(s, "crossword-clue-block"), s.id = o;
    let c = e.createElement("p");
    return c.innerHTML = u, T(c, "crossword-clue-block-title"), s.appendChild(c), s;
  }
  function i(o, u, s) {
    s.forEach((c) => {
      let f = e.createElement("div");
      T(f, "crossword-clue"), f.modelClue = c;
      let a = e.createElement("span");
      T(a, "crossword-clue-label"), a.innerHTML = `${c.labelText}`, f.appendChild(a);
      let m = e.createElement("span");
      T(m, "crossword-clue-text"), m.innerHTML = `${c.clueText} ${c.lengthText}`, f.appendChild(m), f.addEventListener("click", (g) => {
  ...
  return T(l.wrapper, "crossword-clues"), i(n, l.acrossClues, n.model.acrossClues), l.wrapper.appendChild(l.acrossClues), i(n, l.downClues, n.model.downClues), l.wrapper.appendChild(l.downClues), n.addEventsListener(["clueSelected"], (o) => {
    for (const u of l.acrossClues.children)
      t(u.modelClue) ? T(u, "current-clue-segment") : Le(u, "current-clue-segment");
...
function Qr(e, n, r) {
  ...
  T(i, "crossword-grid"), i.style.setProperty("--row-count", n.height), i.style.setProperty("--column-count", n.width);
...
function Xr(e, n) {
  ...
  if (r.id = n, T(r, "cwcell"), n.cellElement = r, T(r, n.light ? "light" : "dark"), !n.light)
    return r;
  ...
  if (i.id = `input-${n}`, i.maxLength = 1, i.size = 1, n.answer && (i.value = n.answer), r.appendChild(i), n.labelText) {
    ...
    T(o, "cwclue-label"), o.innerHTML = n.labelText, r.appendChild(o);
  }
  const t = e.createElement("div");
  fn(t, ["cwcell-revealed", "hidden"]), r.appendChild(t);
  const l = e.createElement("div");
  return fn(l, ["cwcell-incorrect", "hidden"]), r.appendChild(l), n.acrossTerminator && T(i, "cw-across-word-separator"), n.downTerminator && T(i, "cw-down-word-separator"), r;
}
function Rn(e, n) {
  const [r, i, t] = [
    n,
...
function ei(e, n, r) {
  d(n, "newClue is undefined"), r == null || r.headSegment.flatCells.forEach((i) => {
    Le(e.inputElement(i), "active");
  }), n.headSegment.flatCells.forEach((i) => {
    T(e.inputElement(i), "active");
  });
}
function ni(e, n, r) {
  d(n, "newCell is undefined"), r && Le(e.inputElement(r), "highlighted"), T(e.inputElement(n), "highlighted");
}
...
function nn(e, n) {
  ...
  Ue(e, n, t, !1), Vn(e.revealedElement(n)), ue(e.incorrectElement(n));
}
function ri(e, n) {
...
function je(e, n) {
  return e ? L.incorrect : n ? L.incomplete : L.correct;
}
function Pe(e, n, r = !0) {
  d(e, "<controller> is null or undefined"), d(n, "<cell> is null or undefined");
  const [i, t] = n.acrossClue ? [n.acrossClue, n.acrossClueLetterIndex] : [n.downClue, n.downClueLetterIndex], l = i.answer[t], o = i.solution ? i.solution[t] : void 0, u = je(
    !(l === o || l === " "),
    l === " " || l === void 0
  );
  return u === L.incorrect && r && Vn(e.incorrectElement(n)), u;
}
function ti(e, n, r = !0) {
  ...
  return n.headSegment.flatCells.forEach((l) => {
    const o = Pe(e, l, r);
    o === L.incorrect ? i += 1 : o === L.incomplete && (t += 1);
  }), je(i > 0, t > 0);
}
function li(e, n = !0) {
  ...
  return e.model.lightCells.forEach((t) => {
    const l = Pe(e, t, n);
    l === L.incorrect ? r += 1 : l === L.incomplete && (i += 1);
  }), je(r > 0, i > 0);
}
function oi(e) {
  d(e, "<controller> is null or undefined");
...
function qn(e, n, r = !1) {
  d(e, "<controller> is null or undefined"), d(n, "<cell> is null or undefined"), Ue(e, n, " "), ue(e.incorrectElement(n)), r && ue(e.revealedElement(n));
}
function ui(e, n) {
...
function Gn(e, n) {
  d(e, "<controller> is null or undefined"), d(n, "<cell> is null or undefined");
  const r = Pe(e, n) === L.incorrect;
  r && (Ue(e, n, " ", r), ue(e.incorrectElement(n)));
}
function ci(e, n) {
...
` + u;
  for (c = Ve(e.buffer, i[o], t[o], e.position, a), u += S.repeat(" ", n.indent) + qe((e.line + 1).toString(), f) + " | " + c.str + `
...
var Qn = We, Xn = new _("tag:yaml.org,2002:str", {
  kind: "scalar",
...
}), K = Object.prototype.hasOwnProperty, ke = 1, mr = 2, gr = 3, Ie = 4, Ge = 1, ft = 2, gn = 3, dt = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, ht = /[\x85\u2028\u2029]/, pt = /[,\[\]\{\}]/, xr = /^(?:!|!!|![a-z\-]+!)$/i, Cr = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function xn(e) {
...
var wn = {
  YAML: function(n, r, i) {
    var t, l, o;
    n.version !== null && h(n, "duplication of %YAML directive"), i.length !== 1 && h(n, "YAML directive accepts exactly one argument"), t = /^([0-9]+)\.([0-9]+)$/.exec(i[0]), t === null && h(n, "ill-formed argument of the YAML directive"), l = parseInt(t[1], 10), o = parseInt(t[2], 10), l !== 1 && h(n, "unacceptable YAML version of the document"), n.version = i[0], n.checkLineBreaks = o < 2, o !== 1 && o !== 2 && Fe(n, "unsupported YAML version of the document");
  },
  TAG: function(n, r, i) {
    var t, l;
...
function vt(e, n, r) {
  ...
  for (e.kind = "scalar", e.result = "", l = o = e.position, u = !1; g !== 0; ) {
    if (g === 58) {
      ...
      if (e.position === e.lineStart && Ye(e) || r && ne(g))
        break;
      if (B(g))
    ...
    u && (Y(e, l, o, !1), on(e, e.line - s), l = o = e.position, u = !1), Q(g) || (o = e.position + 1), g = e.input.charCodeAt(++e.position);
  }
...
function yt(e, n) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, i = t = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      ...
      B(r) ? (Y(e, i, t, !0), on(e, b(e, !1, n)), i = t = e.position) : e.position === e.lineStart && Ye(e) ? h(e, "unexpected end of the document within a single quoted scalar") : (e.position++, t = e.position);
...
function Et(e, n) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = i = e.position; (u = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (u === 92) {
      ...
      B(u) ? (Y(e, r, i, !0), on(e, b(e, !1, n)), r = i = e.position) : e.position === e.lineStart && Ye(e) ? h(e, "unexpected end of the document within a double quoted scalar") : (e.position++, i = e.position);
  }
...
function At(e, n) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), w = e.input.charCodeAt(++e.position); w !== 0; ) {
    ...
    r ? w === 44 && h(e, "expected the node content, but found ','") : h(e, "missed comma between flow collection entries"), A = y = N = null, a = m = !1, w === 63 && (c = e.input.charCodeAt(e.position + 1), O(c) && (a = m = !0, e.position++, b(e, !0, n))), i = e.line, t = e.lineStart, l = e.position, se(e, n, ke, !1, !0), A = e.tag, y = e.result, b(e, !0, n), w = e.input.charCodeAt(e.position), (m || e.line === i) && w === 58 && (a = !0, w = e.input.charCodeAt(++e.position), b(e, !0, n), se(e, n, ke, !1, !0), N = e.result), g ? re(e, u, C, A, y, N, i, t, l) : a ? u.push(re(e, null, C, A, y, N, i, t, l)) : u.push(y), b(e, !0, n), w = e.input.charCodeAt(e.position), w === 44 ? (r = !0, w = e.input.charCodeAt(++e.position)) : r = !1;
  }
  h(e, "unexpected end of the stream within a flow collection");
}
function bt(e, n) {
  var r, i, t = Ge, l = !1, o = !1, u = n, s = 0, c = !1, f, a;
  ...
  for (e.kind = "scalar", e.result = ""; a !== 0; )
    if (a = e.input.charCodeAt(++e.position), a === 43 || a === 45)
      Ge === t ? t = a === 43 ? gn : ft : h(e, "repeat of a chomping mode identifier");
    else if ((f = xt(a)) >= 0)
  ...
  for (; a !== 0; ) {
    for (ln(e), e.lineIndent = 0, a = e.input.charCodeAt(e.position); (!o || e.lineIndent < u) && a === 32; )
...
function St(e, n, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), w = e.input.charCodeAt(e.position); w !== 0; ) {
    ...
    if ((e.line === l || e.lineIndent > n) && (A && (o = e.line, u = e.lineStart, s = e.position), se(e, n, Ie, !0, t) && (A ? C = e.result : y = e.result), A || (re(e, a, m, g, C, y, o, u, s), g = C = y = null), b(e, !0, -1), w = e.input.charCodeAt(e.position)), (e.line === l || e.lineIndent > n) && w !== 0)
...
function se(e, n, r, i, t) {
  ...
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, l = o = u = Ie === r || gr === r, i && b(e, !0, -1) && (c = !0, e.lineIndent > n ? s = 1 : e.lineIndent === n ? s = 0 : e.lineIndent < n && (s = -1)), s === 1)
    for (; _t(e) || Tt(e); )
      b(e, !0, -1) ? (c = !0, u = l, e.lineIndent > n ? s = 1 : e.lineIndent === n ? s = 0 : e.lineIndent < n && (s = -1)) : u = !1;
  if (u && (u = c || t), (s === 1 || Ie === r) && (ke === r || mr === r ? y = n : y = n + 1, A = e.position - e.lineStart, s === 1 ? u && (yn(e, A) || St(e, A, y)) || At(e, y) ? f = !0 : (o && bt(e, y) || yt(e, y) || Et(e, y) ? f = !0 : Lt(e) ? (f = !0, (e.tag !== null || e.anchor !== null) && h(e, "alias node should not have any properties")) : vt(e, y, ke === r) && (f = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : s === 0 && (f = u && yn(e, A))), e.tag === null)
...
function kt(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (o = e.input.charCodeAt(e.position)) !== 0 && (b(e, !0, -1), o = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || o !== 37)); ) {
    ...
    o !== 0 && ln(e), K.call(wn, i) ? wn[i](e, i, t) : Fe(e, 'unknown document directive "' + i + '"');
  }
  if (b(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, b(e, !0, -1)) : l && h(e, "directives end mark is expected"), se(e, e.lineIndent - 1, Ie, !1, !0), b(e, !0, -1), e.checkLineBreaks && ht.test(e.input.slice(n, e.position)) && Fe(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Ye(e)) {
...
var Ot = It, Nt = Ft, Ar = {
  loadAll: Ot,
  load: Nt
}, br = Object.prototype.toString, Sr = Object.prototype.hasOwnProperty, un = 65279, $t = 9, he = 10, Rt = 13, Dt = 32, Mt = 33, Bt = 34, ze = 35, Ht = 37, jt = 38, Pt = 39, Ut = 42, _r = 44, Yt = 45, Oe = 58, Kt = 61, Vt = 62, qt = 63, Gt = 64, Tr = 91, Lr = 93, Wt = 96, kr = 123, zt = 124, Ir = 125, k = {};
k[0] = "\\0";
k[7] = "\\a";
k[8] = "\\b";
k[9] = "\\t";
...
function bn(e, n, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      i
    ) : i && e !== _r && e !== Tr && e !== Lr && e !== kr && e !== Ir) && e !== ze && !(n === Oe && !t) || An(n) && !Ne(n) && e === ze || n === Oe && t
  );
}
function il(e) {
  return me(e) && e !== un && !Ne(e) && e !== Yt && e !== qt && e !== Oe && e !== _r && e !== Tr && e !== Lr && e !== kr && e !== Ir && e !== ze && e !== jt && e !== Ut && e !== Mt && e !== zt && e !== Kt && e !== Vt && e !== Pt && e !== Bt && e !== Ht && e !== Gt && e !== Wt;
}
function tl(e) {
  return !Ne(e) && e !== Oe;
}
...
function ll(e, n, r, i, t, l, o, u) {
  ...
  return !a && !m ? y && !o && !t(e) ? Or : l === pe ? J : Xe : r > 9 && Fr(e) ? J : o ? l === pe ? J : Xe : m ? $r : Nr;
}
...
function sl(e) {
  for (var n = "", r = 0, i, t = 0; t < e.length; r >= 65536 ? t += 2 : t++)
    r = ce(e, t), i = k[r], !i && me(r) ? (n += e[t], r >= 65536 && (n += e[t + 1])) : n += i || Jt(r);
  return n;
}
function cl(e, n, r) {
  var i = "", t = e.tag, l, o, u;
...
function Ln(e, n, r, i) {
  ...
  for (o = 0, u = r.length; o < u; o += 1)
    s = r[o], e.replacer && (s = e.replacer.call(r, String(o), s)), (H(e, n + 1, s, !0, !0, !1, !0) || typeof s > "u" && H(e, n + 1, null, !0, !0, !1, !0)) && ((!i || t !== "") && (t += Qe(e, n)), e.dump && he === e.dump.charCodeAt(0) ? t += "-" : t += "- ", t += e.dump);
  e.tag = l, e.dump = t || "[]";
}
function al(e, n, r) {
...
function fl(e, n, r, i) {
  ...
  for (u = 0, s = o.length; u < s; u += 1)
    m = "", (!i || t !== "") && (m += Qe(e, n)), c = o[u], f = r[c], e.replacer && (f = e.replacer.call(r, c, f)), H(e, n + 1, c, !0, !0, !0) && (a = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, a && (e.dump && he === e.dump.charCodeAt(0) ? m += "?" : m += "? "), m += e.dump, a && (m += Qe(e, n)), H(e, n + 1, f, !0, a) && (e.dump && he === e.dump.charCodeAt(0) ? m += ":" : m += ": ", m += e.dump, t += m));
  e.tag = l, e.dump = t || "{}";
}
function kn(e, n, r) {
  var i, t, l, o, u, s;
...
function dl(e, n) {
  var r = [], i = [], t, l;
  for (Ze(e, r, i), t = 0, l = i.length; t < l; t += 1)
...
var gl = _, xl = Qn, Cl = er, wl = lr, vl = or, yl = tn, El = Ar.load, Al = Ar.loadAll, bl = ml.dump, Sl = F, _l = {
  binary: fr,
  float: tr,
  map: Jn,
  null: nr,
  ...
  seq: Zn,
  str: Xn
}, Tl = sn("safeLoad", "load"), Ll = sn("safeLoadAll", "loadAll"), kl = sn("safeDump", "dump"), Il = {
  Type: gl,
  Schema: xl,
  FAILSAFE_SCHEMA: Cl,
  JSON_SCHEMA: wl,
...
function Gl(e, n) {
  ...
  ) : void 0, [, s, c, f] = Rr.exec(e.clue), a = Yl(s, e), m = Kl(a), [g] = a, C = parseInt(g, 10), y = C.toString(), A = ql(g, l), [, N] = Ol.exec(c), w = jl(N), cn = `(${f})`, an = Vl(f, e), X = an.reduce((Ur, Yr) => Ur + Yr, 0), Pr = e.answer ? e.answer.toUpperCase().replaceAll(/[^ A-Z]/g, " ").padEnd(X) : (
    // pad out null or undefined answer with spaces
    "".padEnd(X)
  );
  if (o && o.length !== X)
    throw new Error(
      `Length of clue solution '${o}' does not match the lengthText '${cn}'`
    );
  if (u && u.length !== X)
    throw new Error(
...
var ie, R, ge, P, q, xe, Ce, we, te, ve, ye, Ee, G, Ae, $e, be, Je, W, ae, z, fe, Se, en, Re, De, _e, Me, I, $, U, ee, le, Te, Be, Hr, He, jr;
class fo {
  //////////////////////////
  //// Lifecycle methods
  //////////////////////////
  constructor(n, r, i) {
    ...
    ), D(this, Ce, r), D(this, xe, i), this.setKeyboardEventBindings([oo, uo]), D(this, Ae, E(this, Se, en).call(this, n)), this.isValid && p(this, Re).call(this);
  }
  ...
  set currentClue(n) {
    ...
    n !== r && (x(`currentClue: '${n}' [currentCell ${this.currentCell}]`), p(this, q).clue = n, ei(this, n, r), this.currentClue.cells.includes(this.currentCell) || (this.currentCell = n.cells[0]), E(this, I, $).call(this, "clueSelected", n));
  }
  ...
  loadCrosswordSource(n, r, i = "") {
    ...
    const t = Mr(n, r);
    return t ? E(this, Se, en).call(this, t) : (x(
  ...
  testCurrentClue() {
    ...
    return E(this, I, $).call(this, "clueTested", r), r === L.correct ? E(this, U, ee).call(this, "clueSolved", this.currentClue) : r === L.incomplete && E(this, U, ee).call(this, "clueIncomplete", this.currentClue), r;
  }
  testCrossword() {
    x("testCrossword");
    const r = li(this, !0);
    return E(this, I, $).call(this, "crosswordTested", r), r === L.correct ? E(this, U, ee).call(this, "crosswordSolved", p(this, P)) : r === L.incomplete && E(this, U, ee).call(this, "crosswordIncomplete", p(this, P)), r;
  }
  revealCurrentCell() {
    nn(this, this.currentCell), E(this, I, $).call(this, "cellRevealed", this.currentCell), E(this, le, Te).call(this);
  }
  revealCurrentClue() {
    ri(this, this.currentClue), E(this, I, $).call(this, "clueRevealed", this.currentClue), E(this, le, Te).call(this);
  }
  revealCrossword() {
    x("revealCrossword"), ii(this), E(this, I, $).call(this, "crosswordRevealed", this.model);
  }
  resetCurrentClue() {
    ui(this, this.currentClue), E(this, I, $).call(this, "clueReset", this.currentClue);
  }
  resetCrossword() {
    x("resetCrossword"), si(this), E(this, I, $).call(this, "crosswordReset", this.model);
  }
  cleanCurrentClue() {
    ci(this, this.currentClue), E(this, I, $).call(this, "clueCleaned", this.currentClue);
  }
  cleanCrossword() {
    x("cleanCrossword"), ai(this), E(this, I, $).call(this, "crosswordCleaned", this.model);
  }
}
ie = new WeakMap(), R = new WeakMap(), ge = new WeakMap(), P = new WeakMap(), q = new WeakMap(), xe = new WeakMap(), Ce = new WeakMap(), we = new WeakMap(), te = new WeakMap(), ve = new WeakMap(), ye = new WeakMap(), Ee = new WeakMap(), G = new WeakMap(), Ae = new WeakMap(), $e = new WeakMap(), be = new WeakSet(), Je = function() {
  return p(this, W, ae).ownerDocument;
}, W = new WeakSet(), ae = function() {
  return p(this, Ce);
}, z = new WeakSet(), fe = function() {
  return p(this, xe);
}, Se = new WeakSet(), en = function(n) {
  var i;
  const r = Wl(n);
  return r ? (this.model && (p(this, W, ae).removeChild(this.gridView), (i = p(this, z, fe)) == null || i.removeChild(this.cluesView), D(this, R, new dn())), D(this, P, r), D(this, we, Qr(
    ...
    E(this, He, jr).call(this, t.cellElement), E(this, Be, Hr).call(this, this.inputElement(t));
  }), p(this, W, ae).appendChild(this.gridView), p(this, z, fe) && (D(this, ge, zr(p(this, be, Je), this)), p(this, z, fe).appendChild(this.cluesView)), this.currentClue = this.model.acrossClues.headSegments[0], E(this, I, $).call(this, "crosswordLoaded", n), !0) : (x("#bindDefinition: crosswordModel creation failed", "error"), !1);
}, Re = new WeakMap(), De = new WeakMap(), _e = new WeakMap(), Me = new WeakMap(), I = new WeakSet(), $ = function(n, r) {
  ...
  d(
    ...
    E(this, I, $).call(this, n, r);
  }, ao);
}, le = new WeakSet(), Te = function() {
  x("checkSolved"), oi(this) === L.correct && E(this, U, ee).call(this, "crosswordSolved", this.model);
}, Be = new WeakSet(), Hr = function(n) {
  d(n, "inputElement is null or undefined");
  const r = this;
  n.addEventListener("focus", (i) => {
    var l;
    const t = r.cell(i.target.parentNode);
    x(`event:focus ${t}`), r.currentCell !== t && (r.currentCell = t), r.lastMoveEvent = "focus", p(l = r, Me).call(l, t);
